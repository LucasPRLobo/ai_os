...
def extract_exif_data(image_path: str) -> Dict:
    ...
    Returns:
        Dictionary containing extracted EXIF data:
        {
            ...
            'location': str or None (e.g., "40.7128°N, 74.0060°W" or place name),
...
def _extract_date_taken(exif_dict: Dict) -> Optional[datetime]:
    ...
    date_tags = [
        (piexif.ExifIFD.DateTimeOriginal, "0th"),  # Original date/time
        (piexif.ExifIFD.DateTimeDigitized, "Exif"),  # Digitized date/time
        (piexif.ImageIFD.DateTime, "0th"),  # General date/time
    ]
...
def _extract_gps_location(exif_dict: Dict) -> Optional[str]:
    ...
    Returns:
        Location string (e.g., "40.7128°N, 74.0060°W") or None
    """
...
print(f"Date taken: {exif_data['date_taken']}")
print(f"Location: {exif_data['location']}")
print(f"Camera: {exif_data['camera_make']} {exif_data['camera_model']}")
print(f"Dimensions: {exif_data['image_dimensions']}")
"""